...
class SenecaPlugin {
    constructor(name, seneca, references) {
        ...
        this._logger = new pip_services_components_node_1.CompositeLogger(this._references);
        this.build();
    }
    get name() {
        return this._name;
    ...
    build() {
        ...
        let senecaDescriptor = new pip_services_commons_node_1.Descriptor('pip-services-seneca', 'seneca', 'instance', '*', '*');
